  ...
  return (
    <section className="sidebar">
      ...
      <div className="text-styles">
        ...
        <select
          onChange={(e) =>
            props.changeTextProperty("fontFamily", e.target.value)
          }
        >
      ...
      <div className="image-styles">
        <label htmlFor="file-upload" className="file-upload">Upload File</label>
        <input type="file" accept="image/*" onChange={props.addImg} id="file-upload"/>
      </div>
    </section>
  );
}
